...
extern void mandelbrotThreadSpeedup(
    int numThreads,
    float x0, float y0, float x1, float y1,
    int width, int height,
    int maxIterations,
...
int main(int argc, char** argv) {
    ...
    //
    // Run the faster threaded version
    //
    ...
    printf("[mandelbrot thread speedup]:\t\t[%.3f] ms\n", minThread * 1000);
    writePPMImage(output_thread, width, height, "mandelbrot-thread-speedup.ppm", maxIterations);
